class AliadasAvailabilityController < ApplicationController
  ...
  def for_calendar
    ...
    availability = find_availability(hours, zone, available_after, aliada_id, service_type)
  ...
  private
    def find_availability(hours, zone, available_after, aliada_id, service_type)
