var CompanyApp = React.createClass({displayName: "CompanyApp",
...
var url = 'http://aliada.rog:3000/rails_admin/aliada/get_schedule/897';
$.ajax({
  url,
  dataType: 'json'
}).done( function( data ) {
...
React.render( React.createElement(CompanyApp, {companies: defCompanies}), document.getElementById( "companyApp" ) );