          ...
          loop_array.map( function( day ) {
            ...
            if( day === '-' ){
              ...
              _.each(that.props.schedules, function( schedule ){
                  ...
                  console.log( schedule.estimated_hours );
                  var schedule_hours = schedule.estimated_hours;
                  var schedule_time = moment( schedule.datetime ).add( schedule_hours.toFixed(), 'hour');
                  if( moment( active_day.format() ).isBetween( schedule_day.format(), estimated_hours.format() ) ){
