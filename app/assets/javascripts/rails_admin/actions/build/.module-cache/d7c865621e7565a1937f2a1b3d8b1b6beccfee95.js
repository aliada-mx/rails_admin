...
var ScheduleRow = React.createClass({displayName: "ScheduleRow",
  render: function() {
    ...
    var first_day = curr.getDate() - curr.getDay();
    var last_day = first + 6;

    var week_first_day = new Date( curr.setDate(first) ).toUTCString();
    var week_last_day = new Date( curr.setDate(last) ).toUTCString();
