...
var ScheduleCell = React.createClass({displayName: "ScheduleCell",
  render: function() {
    ...
    if( this.props.service_type === 1){
      inside_cell = React.createElement("span", {className: "schedule_recurrent"});
    }
    if( this.props.service_type === 2 ){
      inside_cell = React.createElement("span", {className: "schedule_one_time"});
    }
    return (React.createElement("td", {style: rowStyle}, inside_cell, React.createElement("span", {className: "name"}, this.props.text)));
  }
});
