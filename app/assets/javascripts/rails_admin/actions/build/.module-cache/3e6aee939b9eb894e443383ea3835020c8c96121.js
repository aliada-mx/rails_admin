      ...
      React.createElement("tr", null, 
          ...
          loop_array.map( function( day ) {
            ...
            if( day === '-' ){
              ...
              var active_day = moment( week_first_day ).minute(0).hour(that.props.hour);
              ...
              _.each(that.props.schedules, function( schedule ){
                ...
                console.log( active_day.format(), schedule_day.format() );
                if( moment( active_day.format() ).isSame( schedule_day.format() ) )
                  console.log('Samedate: ', active_day, schedule_day );
              });
            }
            return React.createElement(ScheduleCell, {key: day, text: row_text, serviceId: "42"});
          })
...
var ScheduleCell = React.createClass({displayName: "ScheduleCell",
  render: function() {
    ...
    return React.createElement("td", {style: rowStyle}, this.props.text, " - ", this.props.serviceId);
  }
});
