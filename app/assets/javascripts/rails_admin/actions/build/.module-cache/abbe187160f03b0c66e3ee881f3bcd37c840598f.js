          ...
          loop_array.map( function( day ) {
            ...
            if( day === '-' ){
              ...
              _.each(that.props.schedules, function( schedule ){
                  ...
                  var schedule_padding_time = moment( schedule.datetime ).add( schedule_padding_hours.toFixed(), 'hour');
                  ...
                  if( moment( active_day.format() ).isBetween( schedule_day.format(), schedule_padding_time.format() ) ){
                    row_text = schedule.user.full_name;
                    service_type = schedule.service_type_id;
                  }
