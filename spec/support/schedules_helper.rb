module TestingSupport
  module SchedulesHelper
    ...
    def create_one_timer!(starting_datetime, hours: hours, conditions: {}, timezone: 'Mexico City')
    ...
    def create_recurrent!(starting_datetime, hours: hours, periodicity: periodicity, conditions: {}, timezone: 'Mexico City')
      starting_datetime = starting_datetime.in_time_zone(timezone)
      ...
      recurrence_days.times do |i|
        intervals.push(create_one_timer!(starting_datetime, hours: hours, conditions: conditions, timezone: timezone))
